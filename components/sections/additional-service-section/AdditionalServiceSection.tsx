...
import type { AdditionalServiceItemData } from "../../../contracts/service/AdditionalServiceSection";
import { ServiceItem } from "../../items/service-item/ServiceItem";
import { cx } from "../../shared/foundation";
import "./additional-service-section.css";

const additionalServiceRows: AdditionalServiceItemData[][] = [
  [
    {
      serviceType: "washer"
    },
...
export interface AdditionalServiceSectionProps extends HTMLAttributes<HTMLDivElement> {}
...
export function AdditionalServiceSection({
  ...
  return (
    <section {...rest} className={cx("ds-other-service-section", className)}>
      {additionalServiceRows.map((row, rowIndex) => (
